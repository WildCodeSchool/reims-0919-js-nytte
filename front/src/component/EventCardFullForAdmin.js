...
function EventCardFullForAdmin({id, photo, title, category, description, date, time, endTime, isItBookable, place, map, token}){
  console.log({place})
  ...
  <div className="CardFull">
    <button onClick={event=> { event.preventDefault(); history.push(`/happens`) }} className='arrowBack'>
    &laquo;
    </button>
...
export default EventCardFullForAdmin;